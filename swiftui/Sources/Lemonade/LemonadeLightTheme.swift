...
internal struct LemonadeLightThemeInteractionColorsImpl: InteractionColors {
...
internal struct LemonadeLightThemeBorderColorsImpl: BorderColors {
...
internal struct LemonadeLightThemeContentColorsImpl: ContentColors {
...
internal struct LemonadeLightThemeBackgroundColorsImpl: BackgroundColors {
...
public struct LemonadeLightTheme: LemonadeSemanticColors {
    public let interaction: InteractionColors = LemonadeLightThemeInteractionColorsImpl()
    public let border: BorderColors = LemonadeLightThemeBorderColorsImpl()
    public let content: ContentColors = LemonadeLightThemeContentColorsImpl()
    public let background: BackgroundColors = LemonadeLightThemeBackgroundColorsImpl()
