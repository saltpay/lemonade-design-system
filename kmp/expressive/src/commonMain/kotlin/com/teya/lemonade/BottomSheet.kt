 ...
 * [LemonadeUi.Dropdown].
 *
 * @param expanded Whether the bottom sheet is currently visible. When `false`, the sheet is not composed.
...
public fun LemonadeUi.BottomSheet(
    ...
    if (expanded) {
        ModalBottomSheet(
            ...
            containerColor = LemonadeTheme.colors.background.bgElevated,
            tonalElevation = 0.dp,
