    ...
    Column(
        ...
        NoticeRowSection(title = "Without Icons") {
            Column(
                ...
                LemonadeUi.NoticeRow(
                    ...
                    description = "Scheduled maintenance will occur on Saturday from 2-4 AM EST",
                    voice = NoticeRowVoice.Warning,
                    leadingIcon = null,
                )
        ...
        NoticeRowSection(title = "Use Cases") {
            Column(
                ...
                LemonadeUi.NoticeRow(
                    title = "Terms Update",
                    description = "Our terms of service have been updated. Please review the changes to ensure you understand how we process your data and protect your privacy. The new terms will take effect in 30 days.",
                    voice = NoticeRowVoice.Neutral,
                )
            }
        }
