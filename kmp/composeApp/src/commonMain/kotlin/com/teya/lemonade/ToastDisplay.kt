...
internal fun ToastDisplay() {
    Column(
        ...
        InfoToastSection()
        WarningToastSection()
        CriticalToastSection()
        PositiveToastSection()
        WithoutIconToastSection()
    }
}

@Composable
private fun NeutralToastSection() {
...
@Composable
private fun WarningToastSection() {
...
@Composable
private fun CriticalToastSection() {
...
@Composable
private fun PositiveToastSection() {
...
@Composable
private fun WithoutIconToastSection() {
