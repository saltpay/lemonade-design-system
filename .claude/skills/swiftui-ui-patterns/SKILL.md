...
description: Use when creating or refactoring SwiftUI views, designing navigation with TabView/NavigationStack, managing @State/@Binding, composing layouts, or needing component-specific patterns and examples.
---
